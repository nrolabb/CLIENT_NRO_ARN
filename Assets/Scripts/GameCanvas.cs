	...
	public class GameCanvas : IActionListener
	{
		...
		public void update()
		{
			...
			try
			{
				...
				// ẩn nút chuyển tab
				if (!TabController.Instance.isPointerHoldInTab() && currentScreen != null)
		...
		public void keyPressedz(int keyCode)
		{
			...
			if ((keyCode >= 48 && keyCode <= 57) || (keyCode >= 65 && keyCode <= 122) || keyCode == 10 || keyCode == 8 || keyCode == 13 || keyCode == 32 || keyCode == 31 || keyCode == -8 || keyCode == 127)
			{
		...
		public void paint(mGraphics gx)
		{
			try
			{
				...
				// ẩn nút chuyển tab
				TabController.Instance.paint(g);
			}
			catch (Exception)
			{
			}
