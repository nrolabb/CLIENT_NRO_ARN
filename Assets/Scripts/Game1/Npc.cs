...
namespace Game1
{
    public class Npc : Char
    {
    	...
    	public static void clearEffTask()
    	{
    		...
    		{
    			Npc obj = (Npc)GameScr.vNpc.elementAt(i);
    			obj.effTask = null;
    			obj.indexEffTask = -1;
    		}
    	}
    	...
    	public new void paintName(mGraphics g)
    	{
    		...
    		string npcName = template.name;
    		if (ModFunc.isShowID)
    		{
    			npcName = "[" + template.npcTemplateId + "] " + npcName;
    		}
    		if (template.npcTemplateId == 3)
    		{
    			if (Char.myCharz().npcFocus != null && Char.myCharz().npcFocus.Equals(this))
    			{
    				mFont.tahoma_7_yellow.drawStringBorder(g, npcName, cx, cy - ch - mFont.tahoma_7.getHeight() - 5, mFont.CENTER, mFont.tahoma_7_grey);
    			}
    			else
    			{
    				mFont.tahoma_7_yellow.drawStringBorder(g, npcName, cx, cy - ch - 3 - mFont.tahoma_7.getHeight(), mFont.CENTER, mFont.tahoma_7_grey);
    			}
    			dyEff = 60;
    		}
    		else
    		{
    			...
    			if (template.npcTemplateId == 50 || template.npcTemplateId == 51)
    			{
    				if (duahau != null)
    				{
    					...
    					if (Char.myCharz().npcFocus != null && Char.myCharz().npcFocus.Equals(this))
    					{
    						mFont.tahoma_7_yellow.drawStringBorder(g, npcName, cx, cy - ch - mFont.tahoma_7.getHeight() - num, mFont.CENTER, mFont.tahoma_7_grey);
    					}
    					else
    					{
    						mFont.tahoma_7_yellow.drawStringBorder(g, npcName, cx, cy - ch - 8 - mFont.tahoma_7.getHeight() - num + 16, mFont.CENTER, mFont.tahoma_7_grey);
    					}
    				}
    				return;
    			}
    			if (template.npcTemplateId == 6)
    			{
    				if (Char.myCharz().npcFocus != null && Char.myCharz().npcFocus.Equals(this))
    				{
    					mFont.tahoma_7_yellow.drawStringBorder(g, npcName, cx, cy - ch - mFont.tahoma_7.getHeight() - 16, mFont.CENTER, mFont.tahoma_7_grey);
    				}
    				else
    				{
    					mFont.tahoma_7_yellow.drawStringBorder(g, npcName, cx, cy - ch - 8 - mFont.tahoma_7.getHeight(), mFont.CENTER, mFont.tahoma_7_grey);
    				}
    				return;
    			}
    			if (TileMap.mapID != 51)
